...
.add-to-cart-btn:hover { border-color: var(--color-red); background-color: var(--color-rose-100); color: var(--color-red); }
.add-to-cart-btn:active { background-color: var(--color-red); border-color: var(--color-red); color: #fff; }
...
.counter-box .quantity { font-weight: 600; font-size: 16px; }
...
.icon-btn svg path { fill: #fff; }
.icon-btn:hover { border-color: #CAAFA7; }
.icon-btn:hover svg path { fill: #CAAFA7; }
...
.animate-card { animation: pulse 0.5s ease; }
.active-card { border: 1px solid var(--color-red); box-shadow: 0 0 8px rgba(199, 59, 15, 0.25); }
</style>
